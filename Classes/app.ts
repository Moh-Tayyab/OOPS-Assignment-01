...
//(method)
  studentDetails() {
    return `I'm ${this.name}, I'm ${
      this.age
    } year old, my hobbies is ${this.hobbies.join(" ,")}. My Grade is ${
      this.grade
    }`;
  }
}
...
let teacher1 = new Teacher("Muhammad",21, ["teaching", "coding"], "Python Fast API",
{street: "Main street", city: "karachi"});
